...
class Cluster(object):
    ...
    def add_document(self, doc):
        if self.word_distribution is None:
            ...
            self.word_distribution += doc.word_distribution
        self.word_count += doc.word_count
        self.documents.append(doc.index)
...
class Particle(object):
    ...
    def __init__(self, weight):
        ...
        self.cluster2topic_ID = {}
        self.alpha = {} # key = topic_index, value = alphas for a specific topic

        self._Q0 = 0
        self.time_likelihood = 0
